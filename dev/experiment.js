...
function runExperiment(trials, workerId, assignmentId, hitId, PORT, FULLSCREEN) {
  ...
  let instructions = {
    ...
    pages: [
      ...
      <p><b>If any of the other images are the same, you do not need to worry about distinguishing your description from these items.</b> You will be asked to make a total of 72 descriptions. Please answer carefully to all items. Some images may be simpler to describe than others. Responding randomly or carelessly will result in a decline in payment At the end, you will get a completion code. <p> <img src="img/demo.png"> <p>   Here you could for example simply respond: Circle.  <p> <img src="img/demo2.png"> <p> For this example yoy might say: Three thick vertical lines. <p> Do not use location of the red rectangle i.e., top right, as your description must be understood even if the order of the images are mixed.
            </p> ${continue_space}`
    ]
  };
